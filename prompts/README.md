...
- **For warm-up movements:** Use **30-second time blocks per movement** rather than rep counts. For bilateral movements like arm circles, 30 seconds represents total time in both directions combined.
- Consult `unit15/class-plans/Temp/CF-Coaching Fundamentals.pdf` for teaching cues, fault correction, scaling options, and coaching drills.
- Warm-ups should usually be:
